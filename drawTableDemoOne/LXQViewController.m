...
- (void)viewDidLoad {
  ...
  NSArray *tableHeaderIdArray=@[ @"REGION_DESC", @"DAY_FLUX", @"DAY_SAME_RATE", @"MON_FLUX", @"MON_SAME_RATE", @"MON_RING_RATE", @"FLUX_4G_RATE", @"FLUX_34G_RATE", @"TD_FLUX_RATE" ];
  NSArray *tableHeaderNameArray=@[ @"地域", @"日流量", @"同比", @"月流量", @"同比", @"月环比", @"4G流量占比", @"34G流量分流比", @"T网流量占比" ];
